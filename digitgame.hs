...
-- Game with dice and digits (a wooden game owned by the
-- Andreas Junghanns family). This is a game most commonly
-- known as "Shut The Box".
--   https://secure.wikimedia.org/wikipedia/en/wiki/Shut_the_Box
